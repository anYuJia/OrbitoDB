...
import type { AppError, ConnectionConfig, ConnectionDiagnostics, ConstraintInfo, IndexInfo, QueryResult } from "./types";
...
// baked in. Override with localStorage "orbitodb.bridge" to point elsewhere.
