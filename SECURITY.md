...
OrbitoDB is under active development. Security fixes are applied to the latest
...
[**private vulnerability reporting**](https://github.com/anYuJia/OrbitoDB/security/advisories/new)
...
OrbitoDB is local-first and stores credentials in the OS keychain (desktop) or
